...
import com.ahmdalii.medicinereminder.databinding.FragmentMedicationsBinding;
...
public class MedicationsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        medicationsViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
